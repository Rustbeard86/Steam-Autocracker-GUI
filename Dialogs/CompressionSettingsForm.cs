...
public partial class CompressionSettingsForm : Form
{
    ...
    public CompressionSettingsForm()
    {
        ...
        MouseDown += CompressionSettingsForm_MouseDown;
        ...
        // Load saved format
        string savedFormat = Settings.Default.CompressionFormat ?? "ZIP";
        ...
        UseRinPassword = AppSettings.Default.UseRinPassword;
        ...
        var convertToDdlCheckBox = new CheckBox
        {
            ...
            Checked = !Settings.Default.SkipPyDriveConversion
        };
        convertToDdlCheckBox.CheckedChanged += (s, e) =>
        {
            Settings.Default.SkipPyDriveConversion = !convertToDdlCheckBox.Checked;
        ...
        Deactivate += (s, e) =>
        {
            ...
            if (Owner != null && ActiveForm == Owner)
            {
    ...
    public static long UploadBandwidthLimitBytesPerSecond { get; private set; } // 0 = unlimited
    ...
    private void SliderPanel_Paint(object sender, PaintEventArgs e)
    {
        ...
        var trackRect = new Rectangle(trackStart - 3, trackY - 3, trackWidth + 6, 6);
        ...
        // Glass handle body
        var handleRect = new Rectangle(handleX - 7, trackY - 7, 14, 14);
    ...
    private void okButton_Click(object sender, EventArgs e)
    {
        ...
        AppSettings.Default.UseRinPassword = UseRinPassword;
